...
CREATE INDEX "case_actions_payment_idx" ON "app"."case_actions" USING btree ("payment_id","signal_type");--> statement-breakpoint
...
CREATE INDEX "position_program_idx" ON "app"."payment_position" USING btree ("program");--> statement-breakpoint
