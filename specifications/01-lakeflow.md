...
**Payment volume + queue depth** (sampled demo figures; the $-scale figures are talk-track for a real ~$60B/yr agency where 1 point of the ~6% improper rate = ~$600M/yr prevented pre-disbursement):
